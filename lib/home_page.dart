...
Future<List<IN02M>> fetchIN02M(http.Client client, String fDate, String tDate) async {

  final uri = Uri.parse(base+'IN02M/GetByDate/').replace(queryParameters: {
    'fDate': fDate,
    'tDate' : tDate
  });
      ...
      body: Column(
        children: [
          ...
          Expanded(child: Center(
            child: isLoad? FutureBuilder<List<IN02M>>(
                future: fetchIN02M(http.Client(),DateFormat('MM-dd-yyyy').format(fDate),DateFormat('MM-dd-yyyy').format(tDate)),
