    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
              ...
              child: Column(
                  ...
                  children: [
                    Row(children: [
                      ...
                      Text(
                          'Ngày xuất: ${in02ms[index].voucherDate?.day}/${in02ms[index].voucherDate?.month}/${in02ms[index].voucherDate?.year}',
                          style: const TextStyle(color: Colors.white)),
                    ]),
            ...
            // ignore: avoid_print
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => PageDetail(in02m: in02ms[index])))
          );
        });
  }
}
